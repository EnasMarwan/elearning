...
<head>
    ...
    <link href="{{ asset('assets/dashboard/css/sb-admin-2.rtl.min.css') }}" rel="stylesheet">
    @else
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Charts -->
                ...
                <li class="nav-item @if(Route::currentRouteName() == 'tr.show') active @endif">
                    <a class="nav-link" href="{{route('tr.show')}}">
                        <i class="fa fa-users"></i>
                        <span>{{__('Trainers')}}</span>
                    </a>
                </li>
                <li class="nav-item @if(Route::currentRouteName() == 'admin.courses') active @endif">
                    <a class="nav-link" href="{{route('admin.courses')}}">
                        <i class="fa fa-folder"></i>
                        <span>{{__('Courses')}}</span>
                    </a>
                </li>
                <li  class="nav-item @if(Route::currentRouteName() == 'students.show') active @endif">
                    <a class="nav-link" href="{{ route('students.show')}}">
                        <i class="fa fa-users"></i>
                        <span>{{__('Students')}}</span></a>
                </li>
                <li class="nav-item @if(Route::currentRouteName() == 'messages') active @endif">
                ...
                @else
                <li class="nav-item @if(Route::currentRouteName() == 'trainer.profile' ||
                Route::currentRouteName() == 'profile'
                ) active @endif">
                    <a class="nav-link" 
                        @auth('trainer') href="{{ route('trainer.profile')}}"
                            @else
                            href="{{ route('profile')}}"
                        @endauth
                    >
                ...
                <li class="nav-item 
                @if(
                Route::currentRouteName() == 'courses.index' || Route::currentRouteName() == 'dashboard' ) 
                active 
                @endif">
                    <a class="nav-link" 
                        @auth('trainer')
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ $title ?? __('Dashboard') }}</h1>
